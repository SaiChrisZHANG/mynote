...
$$
by a simple contradiction argument. In view of \ref{eq:L2bound_loss_subvector2} and the hard-thresholding feature of $\hat{\boldsymbol{\beta}} = \left( \hat{\boldsymbol{\beta}_{0,1}}^{\prime},\hat{\boldsymbol{\beta}_{0,2}}^{\prime} \right)^{\prime}$
