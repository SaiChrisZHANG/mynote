...
\begin{itemize}
    \item \myhl[myblue]{\underline{\textbf{eigenvalue condition}}}: for some positive constant $\kappa_0$, $\min_{\lVert\boldsymbol{\delta}\rVert _2=1,\lVert\boldsymbol{\delta}\rVert _0<2s}\frac{1}{\sqrt{n}}\lVert\mathbf{X}\boldsymbol{\delta}\rVert _2\geq \kappa_0$
\end{itemize}
