...
\begin{itemize}
    ...
    \end{align*}
    where $\tilde{\boldsymbol{\delta}}_2$ is the subvector of $\boldsymbol{\delta}_2$ consisting of the components with the $s$ \textbf{\textit{largest}} absolute values. Here, Condition \textbf{(A)} is a sparse eigenvalue condition, Condition \textbf{(B)} combines the restricted eigenvalue assumptions in \citet{bickel2009simultaneous}\footnote{}
