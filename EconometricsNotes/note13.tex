...
\begin{itemize}
    ...
    \begin{align*}
        \underbrace{\frac{1}{4n}\lVert \mathbf{X} \boldsymbol{\delta} \rVert^2_2 \geq \frac{\kappa_0^2}{4} \lVert \boldsymbol{\delta} \rVert^2_2}_{\text{Condition 1(A)}} \geq \frac{\kappa_0^2}{4}\left(  \right)
    \end{align*}
\end{itemize}
