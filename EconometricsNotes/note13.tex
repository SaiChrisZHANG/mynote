...
\begin{itemize}
    \item \myhl[myblue]{\textbf{Convex}} methods: good prediction power and oracle inequalities, but challenging to provide tight \underline{false sign rate control}
\end{itemize}
