...
sign consistency: $\mathrm{sgn}\left(\hat{\boldsymbol{\beta}}\right) = \mathrm{sgn}\left(\boldsymbol{\beta}_0\right)$. Under this result, applying Theorem 1 of \citet{lv2009unified}
