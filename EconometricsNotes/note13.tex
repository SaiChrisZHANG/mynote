...
$$
this gives that each component of $\hat{\boldsymbol{\beta}}_{0,1}$ has magnitude larger than $(1-c_1)\lambda$. Since $\lVert n^{-1}\mathbf{X}'_1\boldsymbol{\epsilon} \rVert _{\infty} \leq \lVert n^{-1}\mathbf{X}'\boldsymbol{\epsilon} \rVert _{\infty}\leq \frac{\lambda_0}{2}$ on the event $\mathcal{E}$
