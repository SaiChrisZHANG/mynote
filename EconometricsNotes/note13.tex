...
The global minimizer established so far has nice properties, but due to the non-convexity, there might be computational difficulties in finding such global minimizer.
