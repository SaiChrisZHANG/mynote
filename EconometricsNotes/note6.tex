...
\subparagraph*{Dynamic causal effects} compare the potential outcomes for $i$ at $t$ along different assignment paths, \citet{bojinov2021panel} focus on \textbf{lag-$p$ dynamic causal effects},
