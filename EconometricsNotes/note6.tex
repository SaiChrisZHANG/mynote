...
design an optimal experiment $p=p_1$ for the first unit, get the sampling average $\hat{\tau}_{p_1}$, the conservative sampling variance $\hat{\sigma}^2_{p_1}$, and $p=p_2$ for the second.
