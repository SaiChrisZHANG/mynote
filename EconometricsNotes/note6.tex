...
\begin{align}
    ...
    \end{bmatrix}  \right)
\end{align}
where $\xi^{+2}_{\epsilon,t}/t = \xi^2_{\epsilon} + 2 (\sigma^2_{\epsilon})^2/(t-1)$, and $\sqrt{\left\vert \mathcal{S}_{ntu} \right\vert} \left(\hat{\xi}^2_{ntu,t}-\xi^2_{\epsilon}\right) = O_p(1) $
