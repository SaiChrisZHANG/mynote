...
Since $\mathbf{W}_{1:T}$ is random, the Horvitz-Thompson estimator is also random, when the assignment path satisfies a regular switchback, the probabilities in the denominator are known.
