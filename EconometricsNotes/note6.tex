...
\begin{itemize}
    ...
    \begin{itemize}
        \item unit-specific parameters (individual FEs) can not be estimated consistently due to the short time series
...
In the most general case, the treatment may vary both across units and over time,
