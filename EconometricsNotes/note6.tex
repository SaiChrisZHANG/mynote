...
\begin{itemize}
    ...
    \end{align*}
    \item for repeated cross-section data,
    \begin{equation*}
    ...
    \end{equation*}
    where $\mu^{rc}_{0,Y}\left(Y,X;\beta^{rc}_{0,0},\beta^{rc}_{0,1}\right) = T\cdot \mu^{rc}_{0,1}\left(\cdot;\beta^{rc}_{0,1}\right)+(1-T)\mu^{rc}_{0,0}\cdot \left(\cdot; \beta^{rc}_{0,0}\right)$.
\end{itemize}
