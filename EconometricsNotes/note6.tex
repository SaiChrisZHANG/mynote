...
Under A1 and A2 of Assumption \ref{assump:sa2021assump}, the DiD estimator using any pre-period $s<a$ and non-empty control cohorts $C$ is unbiased and consistent.
