...
where $\alpha_i$ and $\beta$ are unobserved unit and time FEs, $\mathbf{X}_i\in\mathbb{R}^{d_x}$ are observed covariates, $\mathbf{u}_i\in\mathbb{R}^{d_u}$ are latent covariates.
