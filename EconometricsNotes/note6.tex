...
\begin{assumption}{Assumptions of \citet{xiong2024optimal}}{xiongetal2024}
    \begin{itemize}
        ...
        \item[A2] \myhl[violet!60!white]{\textbf{Potential Outcome Model}}: the potential outcomes for unit $i$ at time $t$ can be written as $$ Y_{it}(z_{i,t-l},\cdots,z_{i,t-1},z_{it}) $$ 
    \end{itemize}
\end{assumption}
