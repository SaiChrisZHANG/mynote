...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \end{align*}
            nonparametrically using series methods, then estimate 
            \begin{align*}
            ...
            \end{equation*}
            for bias control, the order of the kernel should be at least as large as the dimension of the covariates 
        \end{itemize}
    \end{itemize}
