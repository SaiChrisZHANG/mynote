...
Assuming stationarity, $$ \frac{\partial \mathbb{E}\left(Y_{t+1}\mid G=0,Y_t=y\right)}{\partial y}<1,\forall y $$
then \citet{ding2019bracketing} establishes that the relative magnitude of $\tilde{\mu}_{0,uncf}$ and $\tilde{\mu}_{0,TWFE}$ depends 
\begin{itemize}
