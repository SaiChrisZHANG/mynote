...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item solution: \citet{abadie2021penalized} propose a synthetic control estimator penalizing pairwise matching discrepancies between the treated units and each of the donor units.
    \end{itemize}
\end{itemize}
