...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        the maximum over all observations of the matching discrepancy. If it's large relative to the \textbf{sample standard deviation} of the $k$-th component of the coviarates, one should concern.
    \end{itemize}
