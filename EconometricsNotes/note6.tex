...
\citet{gunsilius2023distributional} chooses weights on the control groups s.t. the \textbf{marginal distribution} for the weighted controls matches that for the treated group.
