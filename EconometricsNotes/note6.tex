...
\begin{itemize}
    \item Units \textbf{are not} active decision-makers: the assumption can be guaranteed by design (random treatment assignment each period, or staggered adoption with randomly assigned adoption date)
    \item \textbf{Limited} anticipation:
    \item Units \textbf{are} active decision-makers:
\end{itemize}
