...
\begin{itemize}
    ...
    \end{itemize}
    \item[\textbf{3}] \myhl[myblue]{\textbf{comparing} the 3 approaches}: in general, variance estimates increase when adding treated observations to a sufficiently-overlapping data set, they are approximations unchanged when adding control observations.
\end{itemize}
