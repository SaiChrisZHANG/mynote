...
\begin{assumption}{Assumptions of \citet{xiong2024optimal}}{xiongetal2024}
    ...
    \end{itemize}
\end{assumption}
\citet{xiong2024optimal} allow for carryover effects up to $l$ periods in the past, the average instantaneous effect $tau_0$ and lagged effects $\tau_1,\cdots,\tau_l$ are defined as 
\begin{align*}
    \tau_j \coloneq \frac{1}{NT}\sum^N_{i=1}\sum^T_{t=1} \frac{1}{2} & \left[ Y_{it}\left(-1,\cdots,-1,\underbrace{+1}_{z_{i,t-j}}, +1,\cdots,+1\right) \right.\\
    & \left. -Y_{it}\left( -1,\cdots,-1,\underbrace{-1}_{z_{i,t-j}},+1,\cdots,+1 \right) \right]
\end{align*}
