...
\citet{sun2021estimating} propose to compare the change for a group that adopted in period $t$, $\bar{Y}_{t,a}-\bar{Y}_{a-1,a}$, relative to the chagne for the never-adopters over the same period 
