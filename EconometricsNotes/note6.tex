...
\begin{equation*}
    \hat{tau}_{ATE} = \bar{X}\left(\hat{\beta}_t-\hat{\beta}_c\right) + \sum_{i:W_i=1} \gamma_{t,i}\left(Y^{obs}_i-X_i\hat{\beta}_t\right) -\sum_{i:W_i=0} \gamma_{c,i}\left(Y_i^{obs}-X_i\hat{\beta}_c\right)
\end{equation*}
