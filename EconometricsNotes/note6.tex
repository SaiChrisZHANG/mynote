...
\begin{itemize}
    ...
    \item[A5] instrument: $\exists \tilde{Y}_{i0}$ s.t. $v_{i1}$ and $v_{i2}^0$ are uncorrelated with $\tilde{Y}_{i0}$ given $D_i=0$, $Y_{i1}$ and $\tilde{Y}_{i0}$ are correlated given $D_i=0$
\end{itemize}
