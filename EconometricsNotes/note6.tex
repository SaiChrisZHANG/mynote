...
The optimal treatment designs $\mathbb{A}_{opt}$ do \textbf{not} depend on the value of $\boldsymbol{\tau}$, due to the fact that the estimation error $\hat{\boldsymbol{\tau}}-\boldsymbol{\tau}$ from GLS does not depend on the value of $\boldsymbol{\tau}$.
