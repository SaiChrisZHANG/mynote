...
\begin{itemize}
    ...
    $$ Y_i(0),Y_i(1) \dot T_i\mid X_i $$
    and a testable implication is 
    $$Y_i \bot \mathbf{1}\left\{T_i=0 \right\} \mid X_i,T_i\leq 0 $$
    \item estimating the casual effect of the treatment on a variable known to be \textbf{unaffected} by it, typically a pre-determined variable,
\end{itemize}
