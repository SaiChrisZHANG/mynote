...
\begin{equation*}
    B_{it}\left(j,l\right) = \frac{ C_{i,t-l} -\sum_{i'\in\mathcal{M}_{it}} w^{i'}_{it}C_{i',t-l,j} }{ \sqrt{ \frac{1}{N_1-1} \sum^N_{i'=1}\sum^{T-F}_{t'=L+1}D_{i't'}\left(V_{i',t'-l,j} - \bar{V}_{t'-l,j} \right)^2 } }
\end{equation*}
