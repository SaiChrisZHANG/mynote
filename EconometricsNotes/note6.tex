...
\begin{itemize}
    ...
    \item[(b)] weighting using the relationship between the treatment and the features
    \item[(c)] the weights are based on direct measures of imbalance rather than on propensity score estimates
\end{itemize}
