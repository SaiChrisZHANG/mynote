...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item[3] estimate the same regression function for the controls, but using \textit{only those that are used as matches} for the treated units with weights corresponding to the number of times a control observation is used as a match.
    \end{itemize}
\end{itemize}
