...
Denote the within-period transformed variable as $\dot{A}_{i,t}=A_{i,t}-\bar{A}_{\cdot t}$, the within-unit transformed variable as $\tilde{A}_{i,t}= A_{i,t}-\bar{A}_{i\cdot}$, and the within
