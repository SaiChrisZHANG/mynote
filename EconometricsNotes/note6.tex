...
\begin{itemize}
    ...
    \item \myhl[myred]{\textbf{Convex hull condition}}: sometimes the treated unit might be too extreme in the values of the outcome variable pre-intervention to be approximated by a weighted average of untreated units. One can use L1 difference $\Delta Y_{jt} = Y_{jt}-Y_{jt-1}$ or growth rates $\Delta Y_{jt}/Y_{jt-1}$
\end{itemize}
