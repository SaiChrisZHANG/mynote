...
\paragraph*{D. Mixed} Although one method alone is often sufficient to obtain consistent or even effiicient estimates, mixing methods may eliminate remaining bias and improve precision, since neither matching nor the propensity score methods 
