...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item composition-constant aggregation $$ \theta_{es}^{bal}(e;e') = \sum_a \mathbf{1}\left\{a+e'\leq \mathcal{T}\right\}P\left(a\mid a+e'\leq \mathcal{T}\right)\cdot ATT(a,a+e) $$ which limits the aggregation to the groups participate in the treatment for at least $e'$ periods
    \end{itemize}
    \item[b] how earlier-treated groups are different from the later-treated groups
    \item[c] the cumulative ATE across all groups
\end{itemize}
