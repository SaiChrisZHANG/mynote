...
\subsubsection{Robustness and extensions}
One can apply \myhl[myblue]{\textbf{backdating}} as a diagnostic check to validate synthetic control estimators and use \myhl[myblue]{\textbf{leave-one-out}} method by dropping one donor unit at a time to construct a range of estimators
