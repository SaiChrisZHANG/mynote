...
\begin{itemize}
    ...
    Similarly, \citet{chernozhukov2019practical} propose bias-corrected estimation and CIs for the post-treatment ATE, $ \left(\tau_{T_0+1}+\cdots+\tau_T\right)/(T-T_0) $ in settings when both $T_0$ and $T-T_0$ are large.
\end{itemize}
