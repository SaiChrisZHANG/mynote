...
\begin{itemize}
    ...
    \end{itemize}
    the problem is to solve $\omega_{t+1}$ that minimizers the expected terminat cost, given the random experiment duration $\tilde{T}$:$$ \omega_t = \arg\min_{\omega_t} \mathbb{E}_{\tilde{T}\sim P_t\left(\tilde{T}\right)} $$
\end{itemize}
