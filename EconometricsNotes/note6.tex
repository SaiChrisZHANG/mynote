...
\citet{imbens2004nonparametric} reviews 5 groups of estimation for ATEs under unconfoundedness, 
\begin{itemize}
    \item \myhl[myblue]{textbf{regression}}
    \item \myhl[myblue]{textbf{matching}}
    \item \myhl[myblue]{textbf{propensity score}}
    \item \myhl[myblue]{textbf{mixed}}
    \item \myhl[myblue]{textbf{Bayesian}}
\end{itemize}
