...
\begin{equation*}
    \left\vert \hat{\mu}_c-\mu_c \right\vert \leq \left\Vert \bar{X}_t-X^T_c\gamma \right\Vert _{\infty}\left\Vert \hat{\beta}_c-\beta_c \right\Vert _1 + \left\vert \Sigma_{i:W_i=0}\gamma_i\epsilon_i \right\vert 
\end{equation*}
