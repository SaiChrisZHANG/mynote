...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textit{unbalanced blocks}: if the distributions of the covariates among treated and controled are different, one can either split the blocks into a number of subblocks, or generalize the specification of the propensity score
    \end{itemize}
