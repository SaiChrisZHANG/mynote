...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        where the penalizing parameter $\lambda>0$ reduces interpolation biases and gives unique and sparse minimizer, $\lambda \rightarrow \infty$ converges to one-to-one matching, $\lambda\rightarrow 0$ gives an aggregate minimizer. 
    \end{itemize}
\end{itemize}
