...
\end{align*}
where $Y^{I}_{1t}$ is the observed treated outcome, $Y^{N}_{1t}$ is the unobservable counterfactual outcome. A synthetic control can then be presented by a $J\times 1$ vector of weights $\mathbf{W}=\left(\omega_2,\cdots,\omega_{J+1}\right)'$,
