...
A key underlying assumption is the Stable Unit Treatment Value Assumption (SUTVA), which requires that there is no interference or spillovers between units.
