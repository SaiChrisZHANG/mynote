...
\begin{itemize}
    ...
    \begin{align*}
        w^{i'}_{it} &\varpropto \frac{ \hat{e}_{it}\left(\left\{\left(D_{i,t-l},\mathbf{V}_{i,t-l}'\right)'_{i,t-l}\right\}^L_{l=1}\right) }{ 1- \hat{e}_{it}\left(\left\{\left(D_{i,t-l},\mathbf{V}_{i,t-l}'\right)'_{i,t-l}\right\}^L_{l=1}\right) } & \text{s.t. } \sum_{i'\in\mathcal{M}_{it}} w^{i'}_{it} &=1 
    \end{align*}
