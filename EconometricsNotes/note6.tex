...
\begin{itemize}
    ...
    \begin{align*}
        \frac{1}{N}\sum^N_{i=1}\beta_{i,t,s}\ddot{\sigma}_{W,i,t,s} &\rightarrow \ddot{\kappa}_{W,\beta,t,s} & \frac{1}{N}\sum^N_{i=1}\ddot{\sigma}^2_{W,i,t}\rightarrow\ddot{\sigma}^2_{W,t}
    \end{align*}
\end{itemize}
