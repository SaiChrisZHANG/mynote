...
$r_j$ measures the quality of the fit of a synthetic control for unit $j$ in the post-treatment period, relative to the quality of the fit in the pre-treatment period. One then use the permutation distribution of $r_j$ for inference. 
