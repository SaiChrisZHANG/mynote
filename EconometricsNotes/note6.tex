...
for any $p\in\left\{0,1,\cdots,T-1\right\}$, let $\mathbf{1}_{p+1}=\left({1,\cdots,1}\right)$ be a vector of $p+1$ 1s and $\mathbf{0}_{p+1}=\left(0,\cdots,0\right)$ a vector of $p+1$ 0s.
