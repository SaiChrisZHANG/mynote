...
\end{align*}
which allows for general heterogeneity in treatment effect. Then the ATE or ATT are 
\begin{align*}
...
\begin{align*}
    ...
    \mathbb{E}\left.\partial_n\mathbb{E}\psi \left(W;\theta_0,\eta\right)\right\vert_{\eta=\eta_0} &=0 & \text{Neyman orthogonality condition}
\end{align*}
