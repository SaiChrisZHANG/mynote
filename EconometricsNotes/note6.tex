...
Consider the linear factor model (a generalization of DiD) for $Y_{jt}^N$: $$ Y_{jt}^N = \delta_t + \boldsymbol{theta}_t\mathbf{Z}_j + \boldsymbol{\lambda}_t \boldsymbol{\mu}_j $$
