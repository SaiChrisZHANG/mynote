...
\paragraph*{Inference and testing} given the observed assignment path $\mathbf{w}^{obs}_{1:T}$ and the corresponding observed outcomes $\mathbf{Y}^{obs}_{1:T}$, \citet{bojinov2023design} propose an exact non-parametric test
