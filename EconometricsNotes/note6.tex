...
\begin{itemize}
    ...
    \end{equation*}
    \begin{itemize}
        \item early estimators for $\mu_d$ included parametric regression functions including least-square estimators with the regression function $\mu_d = \beta x+\tau\cdot d$, then 
