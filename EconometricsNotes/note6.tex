...
\begin{itemize}
    ...
    \item \underline{\textbf{Limited} antici}p\underline{ation}: assuming the treatment can be anticipated for a \textbf{fixed number} of periods
    \item \underline{Units \textbf{are} active decision-makers}:
\end{itemize}
