...
\begin{itemize}
    ...
    \begin{itemize}
        \item challenge: optimal weight might not be unique, and typically \textbf{infinite}; if to choose one among the infinite minimizers, large interpolation bias can arise.
    \end{itemize}
\end{itemize}
