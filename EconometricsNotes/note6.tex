...
\begin{equation*}
    \hat{\tau}_p\left(\eta_{\mathbb{T,Q}},\mathbf{w}_{1:T},\mathbb{Y}\right) = \frac{1}{T-p} \sum^T_{t=p+1} \left\{ Y^{obs}_t \frac{\mathbb{1}\left\{\mathbf{w}_{t-p:t}=\mathbf{1}_{p+1}\right\}}{\Pr\left(\mathbf{W}_{t-p:t}=\mathbf{1}_{p+1}\right)} -  \right\}
\end{equation*}
