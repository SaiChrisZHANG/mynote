...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        if unit $i$ is a control unit, or $Y_i=\alpha_1+\beta_1'X_i+\epsilon_i$ for the treated units. If the correction is done nonparametrically, the resulting matching estimator is consistent and asymptotically normal, with its bias dominated by the variance.
        \item[3] 
    \end{itemize}
\end{itemize}
