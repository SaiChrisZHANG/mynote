...
\subsubsection{Design-Based Inference}


\subsubsection{Sampling-Based Inference}
\begin{itemize}
...
Regardless of the level of aggregation, inference for TWFE and DiD estimators typically takes into account the correlation in outcomes over time within units in applications with more than two periods.
