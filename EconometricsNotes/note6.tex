...
\begin{itemize}
    ...
    \item \myhl[myred]{\textbf{No interference}}: in the design phase, one can drop spillover-affected donor units\footnote{There usually is a tradeoff between the no-interference and the availability requirement.}; in the analysis phrase, one should be aware of the potential 
\end{itemize}
