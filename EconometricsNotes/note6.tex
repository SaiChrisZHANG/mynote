...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item non-parametrically estimate the distribution of the propensity score: in practice, one may wish to undersmooth the estimation by choosing a bandwidth smaller than optimal or including higher-order terms
    \end{itemize}
    \item[\textbf{2}] \myhl[myblue]{\textbf{address} the lack of overlapping}
\end{itemize}
