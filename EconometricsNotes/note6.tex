...
\begin{itemize}
    ...
    \item[A2] \textbf{Distribution DiD}: the distribution of the change in untreated potential outcomes does not depend on whether or not the individual belongs to the treated or the untreated group $$ \Delta Y_{0t} \bot D $$
\end{itemize}
