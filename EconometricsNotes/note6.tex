...
\begin{align*}
    \delta\left(F,L\right) &= \mathbb{E}\left[ Y_{i,t+F}\left(D_{it}=1,D_{i,t-1}=0,\left\{D_{i,t-l}\right\}^L_{l=2}\right) - Y_{i,t+F}\left(D_{it}=0,D_{i,t-1}=0,\left\{D_{i,t-l}\right\}^L_{l=2}\right) \right]
\end{align*}
