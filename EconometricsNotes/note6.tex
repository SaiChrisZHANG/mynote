...
\begin{itemize}
    ...
    \end{itemize}
\end{itemize}
when $l=0$ (no carryover effects), the four objective functions are equivalent to one another. The optimal assignment $A=[A_i]_{i\in[N]}$ where $A_i\in[T]\cup \{\infty\}$
