...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item[2] matching variance estimator\footnote{The idea is that one need not actually estimate this variance consistently at all values of the covariates. One needs only the average of this variance over the distribution, weighted by the inverse of either $e(x)$ ot its complement $1-e(x)$.}: the key is to obtain a close-to-unbiased estimator for $\sigma^2_w(x)$  
    \end{itemize}
\end{itemize}
