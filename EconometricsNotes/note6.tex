...
where $g$ summarizes variation from exogenous shocks, $w$ are predetermined variables related to shock exposure, $\{f_l(\cdot)\}^L_{l=1}$ is a set of known non-stochastic functions.
