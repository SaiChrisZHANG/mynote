...
\paragraph{Calculate test statistics} Define and calculate test statistics $W_j$ for each $\beta_j\in\left\{ 1,\cdots,p \right\}$ using $\left[\mathbf{X}\ \tilde{\mathbf{X}}\right]$:
\begin{itemize}
    \item 
\end{itemize}
