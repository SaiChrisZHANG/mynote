...
\begin{theorem}{Oracle Property of the MX Knockoff Procedure}{oracle_mxknockoff}
    ...
    $$
    \mathrm{Power}(\hat{\mathcal{S}}) = \mathbb{E}\left[ \frac{\left\vert \hat{\mathcal{S}}\cap \mathcal{S}_0 \right\vert}{\left\vert \mathcal{S}_0 \right\vert} \right] \geq 1-C_{l_1}C_{\lambda}(\phi +1)k_n^{-1}
    $$
\end{theorem}
