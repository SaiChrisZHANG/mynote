...
\end{itemize}
Implementing this modified procedure, we limit ourselves to sparse models $\tilde{\mathcal{S}}$ with size bounded by some positive integer $K_n$ that diverges with $n$. \citet{fan2020rank} also provide 
