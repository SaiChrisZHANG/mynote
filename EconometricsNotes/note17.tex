...
And an \myhl[myblue]{\textbf{approximate}} construction in high-dimensional situation can be achieved via matching the first 2 moments of $(\mathbf{X},\tilde{\mathbf{X}})_{\mathrm{swap(S)}}$ and $(\mathbf{X},\tilde{\mathbf{X}})$,
