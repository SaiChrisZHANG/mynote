...
The $t-$statistic $$ \frac{\hat{\beta}-\beta}{\sqrt{\mathrm{Var}\left(\hat{\beta}\right)}} \sim \mathcal{N}(b,1),\ \ \lvert b\rvert\leq \frac{\bar{\mathrm{bias}}_{\Gamma}\left(\hat{\beta}\right)}{\sqrt{\mathrm{Var}\left(\hat{\beta}\right)}}$$
