...
$$
This is given by the \textbf{centrosymmetry} of the smooth function. As stated by \citet{armstrong2018optimal}, the functions that solve the single-class modulus problem can be taken to satisfy $g^*_{\delta}= -f$
