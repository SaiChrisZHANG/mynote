...
\newcommand{\lecture}[4]{
   ...
   {\bf Disclaimer}: {\it These notes are written by Sai Zhang (\href{mailto:saizhang.econ@gmail.com}{email me}), for this topic, see \citet*{armstrong2020bias} for more details.}
   \vspace*{4mm}
}
%
...
\begin{document}
\lecture{3}{Bias-Aware Inference}{}{Sai Zhang}
