...
The basic intuition of LARS is quite straight-forward: that is, covariates are considered from the \myhl[myred]{\textbf{\textit{highest}}} corerlation with $\mathbf{y}$ to the \myhl[myblue]{\textbf{\textit{least}}} correlated one.
