...
\subsubsection*{Intuition: Forward Selection}
The basic intuition of LARS echos a classic model-selection method, \textbf{Forward Selection} (forward stepwise regression). T
