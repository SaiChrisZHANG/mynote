...
\begin{minipage}{0.45\textwidth}
    \centering
        \begin{tikzpicture}[scale=1.4]
            ...
            \draw [color = myblue, very thick] (0,2) -- (2,0);
            \draw [color = myred, very thick] (2,0) -- (4,2);
            \draw [color = myblue, very thick, densely dashed] (2.5,-0.5) -- (2,0);
            \draw [color = myred, very thick, densely dashed] (2,0) -- (1.5,-0.5);
        \end{tikzpicture}
\end{minipage}
\hfill
\begin{minipage}{0.45\textwidth}
