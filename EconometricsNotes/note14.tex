...
\begin{theorem}{Sign Consistency and Oracle Inequalities}{sign_consistency}
    Assume the same conditions of Thm.\ref{thm:oracle_inequal}, further assume $\min_{1\leq j \leq s}\lvert \beta_{0,j} \rvert \geq 2\tau $ and $\lambda = c_0\sqrt{\log p/n} = o(\tau)$
\end{theorem}
