...
\end{theorem}
With Thm.\ref{thm:asymptotic_computable_sol}, we have that a \myhl[myblue]{\textbf{computable solution}} produced by any algorithm can share the same nice asymptotic properties as for any global minimizer, when the maximum correlation between
