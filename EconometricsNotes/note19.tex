...
\begin{itemize}
    ...
    $$
    where the constant 2.01 can be replace with any other constant slightly larger than 2, and $$\check{d}_n = \max_{1\leq l\leq n} \sum^n_{j=1}\mathbf{X}_{lj}$$ is the maximum degree of the network.
\end{itemize}
