...
\paragraph*{Network without self loops} In the absence of self loops, the observed data matrix $\mathbf{X}$ takes the form $$ \tilde{\mathbf{X}} - \mathrm{diag}\left(\tilde{\mathbf{X}}\right) $$
