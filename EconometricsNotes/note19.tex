...
\end{definition}
In the SSBM case, algorithms that guarantee $$A(\mathbf{X},\hat{\mathbf{X}}) \rightarrow \frac{1}{k}$$ would be trivial. On the other hand, we the case of \myhl[myred]{\textbf{weak recovery}}
