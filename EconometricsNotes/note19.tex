...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item $\sigma^2_n = \max_i \sum^n_{j=1}\sigma^2_{ij}\xrightarrow{n\rightarrow\infty}\infty$, $\left\vert d_K \right\vert \gtrsim \alpha^2_n $, and $\frac{\left\vert d_K \right\vert}{\alpha_n}\gtrsim n^{\epsilon}$ for some $\epsilon>0$
    \end{itemize}
    \item[\textbf{C4}]
    \item[\textbf{C5}]  
\end{itemize}
