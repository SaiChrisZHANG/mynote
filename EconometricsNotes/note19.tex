...
\begin{definition}{Stochastic Block Model}{stoch_block_model}
    ...
    where vertices $i$ and $j$ are connected with probability $W_{X_i,X_j}$, \myhl[myred]{\textbf{independently}} of other pairs of vertices. And the \textbf{community} sets can be defined 
\end{definition}
