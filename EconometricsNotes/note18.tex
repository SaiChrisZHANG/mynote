...
\begin{itemize}
    ...
    \end{equation}
    where $g_c$ remains bounded as $\mathbf{n},p\xrightarrow{\boldsymbol{\gamma}}\infty$, and the values of $f_c$ and $g_c$ are given as Tab.\ref{tab:fc_gc_values}
    \begin{table}[ht]
        ...
        \begin{center}
          \begin{tabular}{lcccc}
            ...
            CCA & $f_c^{\text{REG}}+f_{21}$ & $\frac{\check{g}_c^{\text{REG}}\check{g}_{10}}{l(\theta)}$ \\ \hline
            \multicolumn{3}{l}{where the terms $o(1)$ do \textbf{not} depend on $\theta$. $l(\theta)=1+\frac{(1+\theta)c_2}{c_1}$, $r^2=c_1+c_2-c_1c_2$.}
          \end{tabular}
        \end{center}
    \end{table}
    \item 
