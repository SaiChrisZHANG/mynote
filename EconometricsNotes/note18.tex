...
\begin{figure}[ht]
    ...
    \centering
      \begin{tikzpicture}[scale=1.4]
          ...
          \draw [-stealth,myblue!45!white,thick] (3,3.5) -- (2.5,3.5) node[above] {$\mathcal{K}_1$};
      ...
      \end{tikzpicture}
      \caption{$\mathcal{K}$ for SMD, PCA, SigD}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \begin{tikzpicture}[scale=1.4]
          ...
          \draw [myblue!45!white,thick] (1.5,3.5) .. controls (2.3325,3.5) and (3,2.8325) .. (3,2);
          \draw [myblue!45!white,thick] (1.5,0.5) .. controls (2.3325,0.5) and (3,1.1675) .. (3,2);
  
          \filldraw[myblue] (3,2) circle (2pt) node[right, xshift=2pt, yshift=-8pt] {$z_0$};
          \filldraw[myblue] (1.5,2) circle (2pt) node[left, xshift=-2pt, yshift=8pt] {$z_1$};
          
        \end{tikzpicture}
        \caption{$\mathcal{K}$ for REG$_0$, CCA}
    \end{minipage}
\end{figure}
