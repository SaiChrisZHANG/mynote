...
$$
where $\boldsymbol{\Theta}$ is an $n\times K $ community membership matrix, and $\mathbf{B}$ is a $K\times K$ symmetric matrix. Then, based on Thm. \ref{thm:spike_eigen_asymptotics}
