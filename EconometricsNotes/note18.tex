...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item $\mathbf{D} = \mathrm{diag}\left(d_1,\cdots,d_K\right)$ is a diagonal matrix of population eigenvalues, with $\left\vert  d_1\right\vert\geq \cdots \left\vert  d_K\right\vert$
    \end{itemize}
\end{itemize}
