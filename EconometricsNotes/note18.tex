...
\begin{figure}[ht]
    ...
    \centering
      \begin{tikzpicture}[scale=1.4]
        ...
        \filldraw[myblue] (3.5,2) circle (2pt) node[right, xshift=2pt, yshift=-8pt] {$z_0$};
        \draw [-stealth,myblue!45!white,thick] (-0.5,0.5) -- (1,0.5);
        \draw [-stealth,myblue!45!white,thick] (1,0.5) -- (3,0.5);
        \filldraw[myblue] (2,0.5) circle (2pt) node[left, xshift=-2pt, yshift=8pt] {$-i 2z_0$};
        \draw [myblue!45!white,thick] (3,0.5) -- (3.5,0.5);
        \draw [-stealth,myblue!45!white,thick] (3.5,1.5) -- (3.5,3) node[right] {$\mathcal{K}_1$};
        \draw [-stealth,myblue!45!white,thick] (3.5,0.5) -- (3.5,1.5);
    ...
    \begin{minipage}[b]{0.45\textwidth}
        ...
        \begin{tikzpicture}[scale=1.4]
            ...
            \draw [-stealth,color=black,thin] (-0.5,2) -- (4,2);
            \draw [-stealth,color=black,thin] (2,0) -- (2,4);
            \filldraw[myblue] (1.5,2) circle (2pt) node[anchor=west] {Intersection point};
        \end{tikzpicture}
    \end{minipage}
\end{figure}
