...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            $$
            \item \myhl[myblue]{j=1,2}: consider the contour integral representations $$ F_j = \frac{C_m}{2\pi \mathrm{i}} \int^{(1+)}_{0} \exp\left\{ -m\varphi_j(t) \right\}\psi_j(t)\mathrm{d}t $$ 
        \end{itemize}
    \end{itemize}
\end{itemize}
