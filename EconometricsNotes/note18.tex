...
\paragraph*{Contour integral representation} The asymptotic behavioral of the likelihood ratios (Eq.\ref{eq:likelihood_ratio}) depends on that of $_{\mathrm{p}}\mathcal{F}_{\mathrm{q}}(a,b;\boldsymbol{\Psi},\boldsymbol{\Lambda})$
