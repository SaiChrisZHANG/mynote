...
\paragraph*{Remarks}
Here, Thm. \ref{thm:asymptotic_moments_LR} establishes the weak convergence of the log likelihood ratio viewed as a random element of the space of continuous functions. This is \textbf{stronger} than simply the cnovergence of the finite dimensional distributions of the log likelihood process.
