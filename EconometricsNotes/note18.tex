...
\begin{table}[h!]
    ...
    \begin{center}
      \begin{tabular}{lcccc}
        ...
        \hline
        $_{\mathrm{0}}\mathcal{F}_{\mathrm{0}}$ & PCA & Principal components analysis & $W_p(n_1,\boldsymbol{\Sigma+\Psi})$ & $n_2\boldsymbol{\Sigma}$ \\
        $_{\mathrm{1}}\mathcal{F}_{\mathrm{0}}$ & PCA & Principal components analysis & $W_p(n_1,\boldsymbol{\Sigma+\Psi})$ & $n_2\boldsymbol{\Sigma}$ \\
        $_{\mathrm{0}}\mathcal{F}_{\mathrm{1}}$ & PCA & Principal components analysis & $W_p(n_1,\boldsymbol{\Sigma+\Psi})$ & $n_2\boldsymbol{\Sigma}$ \\
        $_{\mathrm{1}}\mathcal{F}_{\mathrm{1}}$ & PCA & Principal components analysis & $W_p(n_1,\boldsymbol{\Sigma+\Psi})$ & $n_2\boldsymbol{\Sigma}$ \\
        $_{\mathrm{2}}\mathcal{F}_{\mathrm{1}}$ & PCA & Principal components analysis & $W_p(n_1,\boldsymbol{\Sigma+\Psi})$ & $n_2\boldsymbol{\Sigma}$
      \end{tabular}
    \end{center}
  \end{table}
