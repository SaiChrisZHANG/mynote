...
\begin{theorem}{Asymptotic Distribution of Spiked Eigenvalues and Eigenvectors}{spike_eigen_asymptotics}
    ...
    and 
    \begin{itemize}
        \item If the unit vector $\mathbf{u}$ satisfies that $\left\vert \mathbf{u}'\mathbf{v}_k \right\vert \in [0,1)$, $\alpha^2_n d^2_k \mathrm{var}\left[ \left(\mathbf{b}'_{\mathbf{u},k,t_k} - \mathbf{u}'\mathbf{v}_k\mathbf{v}_k'\right)\mathbf{W}\mathbf{v}_k \right] \rightarrow \infty$
    \end{itemize}
\end{theorem}
