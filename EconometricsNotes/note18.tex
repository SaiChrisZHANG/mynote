...
\begin{equation}
    f_k(z) = 1 + d_k \left\{ \mathcal{R}(\mathbf{v}_k,\mathbf{v}_k,z)-\mathcal{R}(\mathbf{v}_k,\mathbf{V}_{-k},z) \times \left[(\mathbf{D}_{-k})^{-1}+ \mathcal{R}(\mathbf{V}_{-k},\mathbf{V}_{-k},z)\right] \right\}
\end{equation}
