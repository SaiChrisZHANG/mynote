...
\begin{itemize}
    ...
    \end{itemize}
    \item \underline{\textbf{Cond. 3}}: It holds that $\left\vert d_1 \right\vert = O(\left\vert d_K \right\vert)$, $\left\vert d_K \right\vert\sigma_{\min}/\alpha_n\rightarrow\infty $
\end{itemize}
