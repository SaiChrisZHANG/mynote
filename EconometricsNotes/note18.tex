...
\begin{table}[h!]
    ...
    \begin{center}
      \begin{tabular}{lcccc}
        ...
        $_{\mathrm{1}}\mathcal{F}_{\mathrm{0}}$ & PCA & Signal detection & $W_p(n_1,\boldsymbol{\Sigma+\Phi})$ & $W_p(n_2,\boldsymbol{\Sigma})$ \\
        $_{\mathrm{0}}\mathcal{F}_{\mathrm{1}}$ & PCA & Multivariate regression, with known error & $W_p(n_1,\boldsymbol{\Sigma},n_1\boldsymbol{\Phi})$ & $n_2\boldsymbol{\Sigma}$ \\
        $_{\mathrm{1}}\mathcal{F}_{\mathrm{1}}$ & PCA & Multivariate regression, with unknown error & $W_p(n_1,\boldsymbol{\Sigma},n_1\boldsymbol{\Phi})$ & $W_p(n_2,\boldsymbol{\Sigma})$ \\
        $_{\mathrm{2}}\mathcal{F}_{\mathrm{1}}$ & PCA & Canonical correlation analysis & $W_p(n_1,\boldsymbol{\Sigma},\boldsymbol{\Phi}(\mathbf{Y}))$ & $W_p(n_2,\boldsymbol{\Sigma})$
      \end{tabular}
    \end{center}
  \end{table}
