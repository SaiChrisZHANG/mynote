...
\begin{theorem}{Asymptotic Power}{asymptotic_power}
    Let $\bar{\theta}$ be the threshold corresponding to $F_{\boldsymbol{\gamma}}$ as given in Tab.\ref{tab:3classes_distributions}. $\forall \theta\in [0,\bar{\theta})$, the value of the asymptotic power 
\end{theorem}
