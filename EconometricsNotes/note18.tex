...
\begin{theorem}{Asymptotic Distribution of Spiked Eigenvalues and Eigenvectors}{spike_eigen_asymptotics}
    ...
    \begin{itemize}
        ...
        \item If $\left( \alpha_n^{-4} d^2_k + 1 \right)\mathrm{var}\left( \mathbf{v}_k' \mathbf{W}^2 \mathbf{v}_k \right) \rightarrow \infty$ and $\left( \mathbf{b}_{\mathbf{u},k,t_k}' - \mathbf{u}' \mathbf{v}_k\mathbf{v}_k',\mathbf{v}_k \right)$ satisfies that $\mathbf{W}^1$-CLT condition
    \end{itemize}
\end{theorem}
