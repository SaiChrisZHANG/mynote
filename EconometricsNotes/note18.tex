...
\begin{lemma}{Contour Integral Representations for Likelihood Ratios}{contour_integral_represent}
    ...
    \begin{equation}
        \mathcal{L}(\theta;\boldsymbol{\Lambda}) = \frac{\Gamma(s+1)\alpha(\theta)q_s}{\boldsymbol{\Phi}^s_{11}2\pi i}\int_{\mathcal{\Kappa}} _{\mathrm{p}}\mathcal{F}_{\mathrm{q}}(a,b;\boldsymbol{\Psi},\boldsymbol{\Lambda})
    \end{equation}
\end{lemma}
