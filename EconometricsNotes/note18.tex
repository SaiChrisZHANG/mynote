...
\begin{align*}
    \mathbb{E}X(\theta) &= \frac{1}{4}\ln\frac{\left(1-\delta^2(\theta)\right)\left(1-\delta^2(\theta_0)\right)}{\left(1-\delta(\theta)\delta(\theta_0)\right)^2} & \mathrm{Cov}\left(X(\theta_1),X(\theta_2)\right) = -\frac{1}{2}\ln\frac{\left(1-\delta(\theta_1)\delta(\theta_2)\right)\left(1-\delta^2(\theta)\right)}{}
\end{align*}
