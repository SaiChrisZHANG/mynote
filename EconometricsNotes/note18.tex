...
\begin{itemize}
    ...
    \item \myhl[myblue]{\textbf{Multiple spikes}}: the asymptotic analysis can be extended to a \textbf{fixed} number of sub-critical spikes. In the case of slowly increasing number of spikes,
\end{itemize}
