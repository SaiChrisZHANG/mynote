...
Non-convexity of SOFAR objective function poses important algorithmic and theoretical challenges, hence consider a \myhl[myblue]{\textbf{two-step}} approach exploiting the framework of 
