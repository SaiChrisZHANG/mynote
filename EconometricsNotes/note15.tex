...
\begin{itemize}
    \item \underline{\textbf{Step 1}}: minimize \myhl[myblue]{\textbf{$L_1$-penalized squared loss}} for multivariate regression to obtain an initial estimator
    \item \underline{\textbf{Step 2}}: minimize SOFAR objective function in an 
\end{itemize}
