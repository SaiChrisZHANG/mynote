...
\begin{itemize}
    ...
    \item \myhl[myblue]{\textbf{Penalty functions}} can be many kinds of \underline{sparsity-inducing} penalties, including entrywise $L_1$-norm and row-wise $(2,1)$-norm\footnote{$(2,1)$-norm is defined as the summation of absolute values of all components of a matrix.}
\end{itemize}
