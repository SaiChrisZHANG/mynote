...
A simulation of SCAD versus Lasso is presented in Figure \ref{fig:SCADvsLasso}. It's clear that SCAD gives a more consistent estimation of the model. In this simulation, the 
