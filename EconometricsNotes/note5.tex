...
\begin{itemize}
    ...
    \item \myhl[myblue]{\textbf{An alternative bootstrap process}}: \citet{davezies2021empirical} established that under Assumption \ref{assump:jexch_diss_array} and \ref{assump:measurability_assumption} 
\end{itemize}
