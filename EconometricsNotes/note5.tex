...
Let $\Theta$ denote a normed space, endowed with norm $\left\Vert \cdot \right\Vert _{\Theta}$, $\left(\psi_{\theta,h}\right)_{(\theta,h)\in\Theta\times \mathcal{H}}$ denote a class of real, measurable functions.
