...
\citet{chiang2023using} developed a CLT for means of two-way clustered triangular arrays, which provides a theoretical justification for the asymptotic gaussianity of the statistics commonly occurs under two-way clustering.
