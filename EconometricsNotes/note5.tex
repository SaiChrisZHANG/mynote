...
\end{equation*}
where $a_n\rightarrow 1$ is a suitable finite-sample adjustment, and $\hat{\mathbf{S}}_g =\sum^{N_g}_i=1\mathbf{X}_{gi}\hat{U}_{gi}$ with $\hat{U}_{gi} = Y_{gi} - \mathbf{X}'_{gi}\hat{\boldsymbol{\theta}}$
