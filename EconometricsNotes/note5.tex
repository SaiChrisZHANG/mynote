...
\begin{itemize}
    ...
    \item \myhl[myblue]{\textbf{Graphon}} exchangeable random \textit{arrays} exhibit a special dependence structure. Let $\mu$, $\left\{ \left(W_i,A_i\right) \right\}_{i\geq 1}$, $\left\{ \left(X_j,B_j\right) \right\}_{j\geq 1}$ and $\left\{ V_{ij} \right\}_{i\geq 1,j\geq 1}$ be sequences of i.i.d. random variables
\end{itemize}
