...
\begin{theorem}{Convergence of Z-estimators Bootstrap}{z_est_boot_conv}
    ...
    \begin{itemize}
        \item $\left\Vert \Psi(\theta_m) \right\Vert _{\mathcal{H}} \rightarrow 0 \Rightarrow \left\Vert \theta_m-\theta_0 \right\Vert _{\Theta} \rightarrow 0$, $\forall (\theta_m)_{m\in\mathbb{N}}\in \Theta$ 
    \end{itemize}
\end{theorem}
