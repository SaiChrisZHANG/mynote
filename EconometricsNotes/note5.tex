...
\begin{itemize}
    ...
    \begin{equation*}
        v_k = \underbrace{\frac{1}{n_k} \sum^{n_k}_{i=1}\left( \frac{u_{k,i}^2(1)}{\mu_k} + \frac{u^2_{k,i}(0)}{1-\mu_k} \right)}_{\text{robust variance estimator}} - p_k \frac{1}{n_k} \sum^{n_k}_{i=1}\left(u_{k,i}(1)-u_{k,i}(0)\right)^2
    \end{equation*} 
