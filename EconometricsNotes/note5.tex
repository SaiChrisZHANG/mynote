...
\end{equation*}
where $\left\{\alpha_{ij}\right\}^J_{j=0}$ are $i-$specific latent factors, $\left\{\gamma_{tj}\right\}^J_{j=0}$ are $t-$specific latent factors, $\epsilon_{it}$ is an idiosyncratic component.
