...
\begin{equation*}
    \hat{\boldsymbol{\theta}} = \left(\sum^G_{g=1}\sum^{N_g}_{i=1}\mathbf{X}_gi\mathbf{X}'_{gi}\right)^{-1} \left(\sum^G_{g=1}\sum^{N_g}_{i=1}\mathbf{X}_{gi}Y_{gi}\right) = \left(\sum^G_{g=1}\mathbf{X}\right)
\end{equation*}
