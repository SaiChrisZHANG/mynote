...
Consider a \textbf{sequence of populations} indexed by $k$, the $k$-th population has $n_k$ units, indexed by $i=1,\cdots,n_k$, the population is partitioned into $m_k$ clusters, and $m_{k,i}\in $
