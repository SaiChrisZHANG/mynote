...
\begin{assumption}{Assumptions of \citet{yap2023general}}{assump_yap2023}
    \begin{itemize}
        \item[1] {\textbf{dependence structure}}: $W_i \perp W_j $ if $g(i)\neq g(j)$ and $h(i)\neq h(j)$
        ...
        \begin{itemize}
            ...
            \item $\frac{1}{\lambda_n} \max_c \left( \sum_{i\in\mathcal{N}^C_c}\left\vert \omega_i \right\vert\right)^2  \rightarrow 0$: the cluster with the largest weight to have relatively \textbf{small} contribution to the total variance
            \item $\frac{1}{\lambda_n} \sum_c \sum_{i,j\in \mathcal{N}^C_c} A_{ij} \left\vert \omega_i \omega_j \right\vert \leq K_0$
        \end{itemize}
    \end{itemize}
\end{assumption}
