...
\begin{align*}
    ...
    &-p_k \frac{1}{n_k} \sum^{n_k}_{i=1}\sum^{n_k}_{i=1}\left(u_{k,i}(1)-u_{k,i}(0)\right)^2 - p_k\sigma^2_k \frac{1}{n_k} \sum^{n_k}_{i=1} \left( \frac{u_{k,i}(1)}{\mu_k} + \frac{u_{k,i}(0)}{1-\mu_k} \right)^2 \\
...
\begin{itemize}
    \item \myhl[myblue]{\textbf{random sampling} ($q_k=1$)} and \myhl[myblue]{\textbf{random assignment} ($\sigma^2_k=0$)}: then  
\end{itemize}
