...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{clustering}: the regression has $2P\bar{n}_u$ observations and $P+1$ regressors, where $\bar{n}_u$ denotes the average number of observations across all units, then $\frac{n-1}{n-K}=\frac{2P\bar{n}_u-1}{2P\bar{n}_u-(P+1)}\simeq \frac{2\bar{n}_u}{2\bar{n}_u-1}$.
    \end{itemize}
\end{itemize}
