...
\begin{equation*}
    \hat{\tau}^{\text{fixed}}_k = \frac{\sum^{m_k}_{m=1}\sum^{n_k}_{i=1}\mathbf{1}\left\{m_{k,i}=m\right\}R_{k,i}Y_{k,i}\left(W_{k,i}-\bar{W}_{k,m}\right) }{ \sum^{m_k}_{m=1}\sum^{n_k}_{i=1}\mathbf{1}\left\{m_{k,i}=m\right\}R_{k,i}Y_{k,i}\left(W_{k,i}-\bar{W}_{k,m}\right) }
\end{equation*}
