...
\begin{itemize}
    ...
    \item for any $\mathbf{i}=\left(i_1,\cdots,i_k\right),\mathbf{j}=\left(j_1,\cdots,j_k\right)$ in $\mathbb{N}^k$, let $\mathbf{i}\odot \mathbf{j} = \left(i_1j_1,\cdots,i_kj_k\right)$
\end{itemize}
