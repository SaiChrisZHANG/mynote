...
\begin{itemize}
    ...
    \end{itemize}
    \item $\hat{\mathbb{V}}\left[\hat{\boldsymbol{\beta}}\right]$ might have negative elements on the diagonal (Eq. \ref{eq:twowayclu_decomp}), informly, this is more likely to  arise then clustering is doen over the same groups as the fixed effects, also 
    \begin{itemize}
        \item 
    \end{itemize}
\end{itemize}
