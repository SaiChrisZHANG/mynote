...
\begin{itemize}
    ...
    \begin{itemize}
        \item \underline{with attrition}: adding pair FEs does not change the treatment coefficient or its variance, $\hat{\tau}=\hat{\tau}_{fe}$
        \item \underline{without attribution}
    \end{itemize}
    \item 
\end{itemize}
