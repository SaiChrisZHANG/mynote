...
\paragraph*{Smooth functionals of $F_Y$} For the cdf of $Y_{\mathbf{i}}$, suppose that $\mathcal{Y}\subset \mathbb{R}^p$ for some $p\in\mathbb{N}^+$ and $\theta_0 = g(F_Y)$, where $g$ is Hadamard differentiable\footnote{No linearity assumed under Hadamard differentiability.}
