...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item[-] \textbf{\underline{clustered assi}g\underline{nment}}, $\sigma^2_k=\mu_k(1-\mu_k)$: \textbf{no within-cluster} variation in $W_{k,i}$\footnote{This is the upper bound of $\sigma^2_k$, where $A_{k,m}$ can only take the values $0$ or $1$}
                \item[-]  
            \end{itemize}
        \end{itemize}
        \item[\textbf{ii}] 
