...
\begin{align*}
    \sqrt{G}\left( \hat{\boldsymbol{\theta}} - \boldsymbol{\theta} \right) = \underbrace{\left(\frac{1}{G}\sum^G_{g=1}\sum^{N_g}_{i=1}\mathbf{X}_{gi}\mathbf{X}'_{gi}\right)^{-1}}_{\xrightarrow{\mathrm{p}}\mathbf{Q}} 
\end{align*}
