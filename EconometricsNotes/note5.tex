...
\begin{itemize}
    ...
    where $\hat{\tau}_{k,m}$ is the estimated treatment effect (sample average) in cluster $m$. This estimator could be biased from the correlation between the estimation errors of its components (due to $\bar{W}_k$), 
\end{itemize}
