...
\subsection{Robust clustering with a small number of large clusters}
\citet{sasaki2022non} established robust clustering for the cases wher the distribution of cluster sizes follows a power law with exponent less than 2, the conventional clustering method fails\footnote{An example is that California consists of 10\% of total sample among the 51 US states.}.
