...
\begin{itemize}
    ...
    for any $W-X-$exchangeable random array $\left[Y_{ij}\right]_{i\in\mathbb{N},j\in\mathbb{M}}$, there exists another array $\left[Y^*_{ij}\right]_{i\in\mathbb{N},j\in\mathbb{M}}$ generated according to this graphon, such that the two arrays have the \textbf{same distribution}
\end{itemize}
