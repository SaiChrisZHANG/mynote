...
the $r-$th moment of $\sum_g$ might still be infinite if $r>\beta$. Hence, the conventional robust clustering may fail to exist even if $Z_{gi}$ has a bounded second moment.
