...
For random variables $Y_{\mathbf{i}}$ indexed by $\mathbf{i}\in\mathbb{I}_k$\footnote{Some examples are: $Y_{i_1,i_2}$ corresponds to export flows from country $i_1$ to $i_2$, or whether there is a link between node $i_1$ and $i_2$ in a network. $\left\{i_1,\cdots,i_k\right\}$ can also correspond to the different dimensions of clustering.}
