...
\begin{assumption}{Assumptions of $\mathcal{F}$}{assumptions_on_f}
    ...
    \begin{itemize}
        \item[(i)] admits an envelope $F$ with $PF<\infty$ and $\forall \eta >0$, $ \sup_{Q\in\mathcal{Q}}N\left( \eta\left\Vert F \right\Vert _{Q,1},\mathcal{F},\left\Vert \cdot \right\Vert _{Q,1} \right) <\infty $ 
    \end{itemize}
\end{assumption}
