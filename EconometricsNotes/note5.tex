...
$$
where $BL_1$ is the set of bounded and Lipschitz functions from $l^{\infty}(\mathcal{F})$ to $[0,1]$. In contrast with the standard bootstrap for i.i.d. data
$$
\mathbb{E} \left[\mathbb{P}^*_n(f)\mid \left(Y_{\mathbf{i}}\right)_{\mathbf{i}\in\mathbb{I}_k}\right] = \frac{1}{n^k} \sum_{\mathbf{i}\in\mathbb{I}_{n,k}} f(Y_{\mathbf{i}}) \neq \mathbb{P}_n f
$$
