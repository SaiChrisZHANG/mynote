...
\end{theorem}
here, the tail of the distribution of $N_g$ dominates that of $Z_{gi}$, the tail heaviness of the summation $\sum_g = \sum^{N_g}_{i=1}Z_{gi}$ is dictated by that of $N_g$
