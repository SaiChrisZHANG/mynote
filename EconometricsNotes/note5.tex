...
\end{align*}
where $a_n\rightarrow 1$. Again, for a given $k\in \left\{1,\cdots, p\right\}$, let $\sum_g$ and $Z_{gi}$ be the $k$-th coordinate of $\sum^{N_g}_{i=1} \mathbf{X}_{gi}U_{gi}$ and the $k-$th coordinate of $ \mathbf{X}_{gi}U_{gi}$ respectively, 
