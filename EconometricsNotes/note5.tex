...
\begin{itemize}
    ...
    \item \myhl[myblue]{\textbf{Separately exchangeable arrays}} For the case of separately exchangeable arrays (the $n$ units stem from $k$ \textbf{different} populations, or multiway clustering as in \citet{menzel2021bootstrap}), then we must have a stronger version of Assumption \ref{assump:jexch_diss_array}
