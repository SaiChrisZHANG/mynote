...
\end{itemize}
Intuitively, the UCVEs are biased bacause clustering at the unit level does \textbf{not} account for the perfect negative correlation of the treatments of the two units in the same pair.
