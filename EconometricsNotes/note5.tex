...
\begin{itemize}
    ...
    \end{equation*} 
    here, the finite-sample correction vanishes if there is either \textbf{no heterogeneity} in the treatment effects ($u_{k,i}(1)-u_{k,i}(0) = y_{k,i}(1)-y_{k,i}(0) - \tau_k=0$)
\end{itemize}
