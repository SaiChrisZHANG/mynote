...
One case where the Gaussianity holds under the standard twoway clustering is the \textit{sparse network} asymptotics considered in \citet{bickel2011method} \citet{graham2020sparse} consider a bipartite network 
