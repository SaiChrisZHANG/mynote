...
\begin{theorem}{CLT of \citet{sasaki2022non}'s Clustering}{sasakiwang2022thm3}
    ...
    $$
    \mathbf{V}^{\mathrm{WCR}} = \left(\mathbb{E}\left[N_g^{-1}\mathbf{X}_g'\mathbf{X}_g\right]\right)^{-1} \left(\mathbb{E}\left[N_g^{-2}\mathbf{X}_g'\mathbf{X}_g \mathbf{U}_g^2\right]\right)
    $$
\end{theorem}
