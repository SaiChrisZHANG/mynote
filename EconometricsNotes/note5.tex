...
\end{equation*}
Let $\tau_p \equiv \frac{1}{n_p}\sum^2_{g=1}\sum^{n_{gp}}_{i=1}\left[y_{igp}(1)-y_{igp}(0)\right]$ be the ATE in pair $p$, and $\forall d\in\left\{0,1\right\}$, let $\bar{y}_{gp}(d)\equiv \frac{1}{n_{gp}}\sum_i y_{igp}(d)$, $\bar{y}_p(d)\equiv \frac{1}{2}\sum_g \bar{y}_{gp}(d)$, and 
