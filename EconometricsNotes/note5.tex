...
\end{equation*}
and $\mathrm{var}\left(C_{k,m}\right) \leq \mathbb{E}\left[C^2_{k,m}\right]$, the expectation of $\frac{1}{n_kp_kv_k} \left(\frac{1}{\mu_k(1-\mu_k)}\right)^2 \sum^{m_k}_{m=1}C^2_{k,m}$ is  $\hat{V}^{\text{cluster}}_k$ is conservative.
