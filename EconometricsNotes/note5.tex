...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \underline{with attribution}: $\hat{\tau}$ only leverage observations from pairs where both randomization units are observed, while $\hat{\tau}$ also leverage obs. from pairs where only one of the randomization units is observed
    \end{itemize}
    \item 
\end{itemize}
