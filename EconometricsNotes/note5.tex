...
\begin{theorem}{Uniform LLNs and CLTs}{uniform_lln_clt}
    Under Assumption \ref{assump:jexch_diss_array}, 
    \begin{itemize}
        ...
        \item if (\textbf{B}) of Assumption \ref{assump:assumptions_on_f} holds, $\mathbb{G}_n$ converges weakly in $l^{\infty}(\mathcal{F})$ to a centered Gaussian process $\mathbb{G}$ on $\mathcal{F}$ as $n\rightarrow \infty$, the convariance 
    \end{itemize}
\end{theorem}
