...
\begin{itemize}
    ...
    \item[\textbf{3}] without pair fixed effects, the expectation of the difference between UCVEs and PCVEs is \textbf{proportional} to the difference between the between-pair and with-in pair covariance of the two potential outcomes
\end{itemize}
