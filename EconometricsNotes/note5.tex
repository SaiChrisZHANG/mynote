...
\begin{itemize}
    ...
    \begin{itemize}
        \item $\bar{y}_{gp}(d)\equiv \frac{1}{n_{gp}}\sum_i y_{igp}(d)$
        \item $\bar{y}_p(d)\equiv \frac{1}{2}\sum_g \bar{y}_{gp}(d)$
    \end{itemize}
\end{itemize}


, and , let , , and $\bar{y}(d)\equiv \sum_p\bar{y}_p(d)/P$, respectively, denote the average outcome with treatment $d$ in pair $p$'s unit $g$, in pair $p$ and in the entire population
