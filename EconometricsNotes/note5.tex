...
\begin{proposition}{Regression Inference}{regression_inf}
    ...
    \begin{itemize}
        ...
        \item The bootstrap with model selection satisfies Eq.(\ref{eq:bsconsistency_clt}) and (\ref{eq:bsconsistency_piv}) pointwise as $\sigma^2_{al},\sigma^2_{gl},\sigma^2_{el},\sigma^2_{vl}$
    \end{itemize}
\end{proposition}
