...
$$
A_{ij} \coloneq \mathbf{1}\left[W_i \not\perp W_j\right]
$$
...
\begin{theorem}{Asymptotic Normality of \citet{yap2023general}}{asymp_norm_yap2023}
    Under Assumption \ref{assump:assump_yap2023}, $$Q_n^{-1/2} \sum^n_{i=1} \omega_i \left(W_i-\mathbb{E}\left[W_i\right]\right) \xrightarrow{\mathrm{d}} \mathcal{N}\left(0,\mathbf{I}_K\right) $$ further 
    \begin{itemize}
        \item 
    \end{itemize}
\end{theorem}
