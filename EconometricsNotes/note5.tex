...
\begin{itemize}
    \item \myhl[myred]{\textbf{BS-N}} (bootstrap \textit{without} model selection)
    \item \myhl[myred]{\textbf{BS-S}} (bootstrap \textit{with} model selection)
    \item \myhl[myred]{\textbf{BS-C}} (\textit{conservative} bootstrap)
\end{itemize}
