...
\end{itemize}
Notice that $\mathcal{L}_0\left(\bar{\mathbf{q}},\mathbf{c},\varrho\right)$ in Thm. \ref{thm:clt_samp_dist} is a mean-preserving spread of $\mathcal{L}_0\left( \mathbf{q,c},\varrho\right)$ in Thm. \ref{thm:clt_samp_dist}
