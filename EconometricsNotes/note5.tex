...
\begin{theorem}{Asymptotic Normality of \citet{yap2023general}}{asymp_norm_yap2023}
    ...
    \begin{itemize}
        ...
        \item If $\mathbb{E}\left[\mathbf{W}_i\right] = \mu, \forall i$\footnote{Here, the variance estimator need not be consistent, or even conservative. Whether} and $\frac{1}{\lambda_n} \sum_c\sum_{i,j\in\mathcal{N}^C_c}\left\vert \omega_i\omega_j \right\vert \leq K_0$ for some $K_0<\infty$, then
        \begin{align*}
