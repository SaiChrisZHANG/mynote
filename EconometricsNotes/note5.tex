...
\begin{itemize}
    ...
    \end{align*}
    the sign of it depends on the amount of variation in potential outcomes that can be explained by the clusters. In contrast to the lack of sample information about the need to adjust for clustered sample, 
\end{itemize}
