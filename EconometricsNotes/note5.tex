...
\begin{theorem}{Bootstrap Consistency}{bootstrap_consistency}
    ...
    \begin{itemize}
        ...
        \begin{equation}\label{eq:bsconsistency_clt}
            \left\Vert \mathbb{P}^*_{NT}\left( r_{NT} \left(\bar{Y}^*_{NT}-\bar{Y}_{NT}\right) \right) - \mathbb{P}^*_{NT}\left( r_{NT} \left(\bar{Y}_{NT}-\mathbb{E}\left[\bar{Y}_{it}\right]\right) \right) \right\Vert
        \end{equation}
    \end{itemize}
\end{theorem}
