...
\begin{itemize}
    ...
    \item \myhl[myblue]{\textbf{non-exhaustively matched data}}: only observe joint outcomes for a posibly self-selected subset of unit pairs, the resulting sample may still be  
\end{itemize}
