...
\begin{theorem}{Bootstrap Consistency}{bootstrap_consistency}
    Under Assumption \ref{assump:integrability}, 
    \begin{itemize}
        \item the bootstrap \myhl[myblue]{\textbf{with model selection}} satisfies 
        ...
        \item the bootstrap \myhl[myblue]{\textbf{without model selection}} satisfies Eq.\ref{eq:bsconsistency_clt} and Eq.\ref{eq:bsconsistency_piv} \textbf{uniformly} if $q_v=0$
        \item the \myhl[myblue]{\textbf{conservative}} bootstrap satisfies
