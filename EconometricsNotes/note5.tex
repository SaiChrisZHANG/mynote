...
\end{align*}
here, $W_{NT}=\sum^N_{i=1}sum^T_{t=1}w_{it}$ is the potentially non-guassian part, as discussed by \citet{menzel2021bootstrap}. \citet{chiang2023using} argue that if the DGP is treated as a triangular array, 
