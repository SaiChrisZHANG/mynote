...
\begin{itemize}
    \item \myhl[myblue]{\textbf{$W-X-$exchangeable}} $$\left[Y_{\sigma_w(i)\sigma_x(j)}\right]_{i\in\mathbb{N},j\in\mathbb{M}} \overset{d}{=}  \left[Y_{ij}\right]_{i\in\mathbb{N},j\in\mathbb{M}}$$
\end{itemize}
