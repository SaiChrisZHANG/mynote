...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{not clustering}: the regression has $2P$ observations and $P+1$ regressors, then $\frac{n-1}{n-K}=\frac{2P-1}{P-1}\simeq 2$, the DOF adjustment is substantial
    \end{itemize}
\end{itemize}
