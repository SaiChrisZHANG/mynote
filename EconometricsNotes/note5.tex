...
\begin{assumption}{Regression}{bootstrap_regression}
    Assume the model in Eq.(\ref{eq:menzel_linearmodel}) with $\mathbf{x}_{it}u_{it}=f(\alpha_i,\gamma_t,\epsilon_{it})$ and $\alpha_i,\gamma_t,\epsilon_{it}$ are i.i.d. uniform on $[0,1]$.
\end{assumption}
