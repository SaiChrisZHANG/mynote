...
\begin{theorem}{Uniform LLNs and CLTs}{uniform_lln_clt}
    ...
    \begin{itemize}
        \item if (A) of Assumption \ref{assump:assumptions_on_f} holds, $\sup_{f\in\mathcal{F}} \left\vert \mathbb{P}_nf - Pf \right\vert \xrightarrow{\mathbf{a.s.}} 0$ and in $L^1$
    \end{itemize}
\end{theorem}
