...
\begin{itemize}
    ...
    $$
    \citet{davezies2021empirical} showed that for $k=2$, $K(f,f)=0$ for all $f\in\mathcal{F}$, $\sqrt{n}\mathbf{G}_n$ converges \textbf{weakly} in $l^{\infty}(\mathcal{F})$ to $\mathbb{G}^d$
    \item \myhl[myblue]{\textbf{Degenerate cases}}: 
\end{itemize}
