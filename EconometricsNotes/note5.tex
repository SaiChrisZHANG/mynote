...
\begin{equation}\label{twowayclu_centermat}
...
\begin{itemize}
    ...
    \item for \myhl[myblue]{\textbf{small samples}}, Eq. (\ref{eq:oneway_clurob}) is baised downwards. This is corrected (in Stata) by replacing $\hat{\mathbf{u}}_g$ with $\sqrt{c}\hat{\mathbf{u}}_g$, where $c = \frac{G}{G-1}\frac{N-1}{N-K}\simeq \frac{G}{G-1}$. For two-way clustering, there are 2 ways of correction:
    \begin{itemize}
        \item 
    \end{itemize}
\end{itemize}
