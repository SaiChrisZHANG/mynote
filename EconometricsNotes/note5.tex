...
\begin{proposition}{Estimability of Asymptotic Distribution}{estimability_asympdist}
    ...
    where
    \begin{itemize}
        \item $\mathcal{F}$ is the class of functions $f(\alpha,\gamma,\epsilon)$ corresponding to distributions of $Y_{it}$ satisfying Assump. \ref{assump:integrability} and \ref{assump:restrictions_on_lowrankapprox}, for i.i.d. uniform $\alpha_i,\gamma_t,\epsilon_{it}$\footnote{From the Aldous-Hoover representation}
    \end{itemize}
\end{proposition}
