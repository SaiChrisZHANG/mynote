...
\paragraph*{Robust and cluster robust variance estimators} Let $$ \hat{U}_{k,i} = Y_{k,i}-\hat{\alpha}_k - \hat{\tau}_kW_{k,i} $$ be the residuals from the regression of $Y_{k,i}$ on a constant and $W_{k,i}$
