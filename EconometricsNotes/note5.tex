...
\begin{theorem}{Convergence of Smooth Functionals of the Empirical CDF}{conv_smoothcdf}
    ...
    \begin{itemize}
        ...
        $$
        K\left(y_1,y_2\right) = \frac{1}{(k-1)!^2}\sum_{\left(\pi,\pi'\right)\in \mathfrak{S}\left(\left\{\mathbf{1}\right\}\right) \times \mathfrak{S}\left(\left\{\mathbf{1}'\right\}\right)}\mathrm{Cov}\left( \mathbf{1}_{\left\{Y_{\pi(\mathbf{1})\leq y_1}\right\}} \right)
        $$
        \item 
    \end{itemize}
\end{theorem}
