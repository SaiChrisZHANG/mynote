...
\begin{assumption}{Separate Exchangeability}{sep_exchange}
    A \textbf{separately exchangeable} array is an infinite array $\left(Y_{it}\right)_{i,t}$ such that for any integers $\tilde{N},\tilde{T}$ and permutations $\pi_1:\left\{1,\cdots,\tilde{N}\right\}\rightarrow \left\{1,\cdots,\tilde{N}\right\}$ and $\pi_2:\left\{1,\cdots,\tilde{T}\right\}\rightarrow \left\{1,\cdots,\tilde{T}\right\}$, we have 
    $$ \left(Y_{\pi_1(i),\pi_2(t)}\right)_{i,t} \xrightarrow{d} \left(Y_{it}\right)_{i,t} $$
    
    For the sample $Y_{it}$ for $i=1,\cdots, N$ and $t=1,\cdots,T$, 
\end{assumption}
