...
\begin{lemma}{Key Dependence Structure}{davezies_depstruct}
    Assumption \ref{assump:jexch_diss_array} holds \textbf{if and only if} there exists i.i.d. variables $\left(U_J\right)_{J\subset \mathbb{N}^+,1\leq \left\vert J \right\vert \leq k}$
\end{lemma}
