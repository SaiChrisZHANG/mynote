...
\begin{itemize}
    ...
    \end{equation*}
    where $ \bar{W}_k = \frac{1}{N_k\vee 1} \sum^{n_k}_{i=1}R_{k,i}W_{k,i} $, let $v_k^{\text{robust}} = \frac{1}{n_k} \sum^{n_k}_{i=1}\left(\frac{u^2_{k,i}(1)}{\mu_k} + \frac{u^2_{k,i}(0)}{1-\mu_k}\right)$
    \item 
\end{itemize}
