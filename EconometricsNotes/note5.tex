...
\begin{itemize}
    ...
    \item If $N=T$ and within-cluster covariances are bounded away from $0$ in \textbf{at least one dimension}: $\sqrt{N}\left(\bar{Y}_{NT}-\mathbb{E}\left[Y_{it}\right]\right) x\rightarrow{d} \mathcal{N}\left(0,\sigma^2_a+\sigma^2_g\right)$
\end{itemize}
